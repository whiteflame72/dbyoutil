...
/**
 *  Class corresponding to a <i>row7</i> element in XML.
 *  <p>
 ...
 */
public class Row7  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row7"</i>) */
	public static final String ELEMENT_NAME="row7";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row7 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row7"</i> which is this class' corresponding XML Element.
	 */
