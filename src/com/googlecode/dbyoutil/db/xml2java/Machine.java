...
/**
 *  Class corresponding to a <i>MACHINE</i> element in XML.
 *  <p>
 ...
 */
public class Machine  implements XMLPCDataElement {
	/** The name of this class' corresponding XML element. (<i>"MACHINE"</i>) */
	public static final String ELEMENT_NAME="MACHINE";
	//----------------------------------------------------------------------------- attribute member
	/* XML element MACHINE has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"MACHINE"</i> which is this class' corresponding XML Element.
	 */
