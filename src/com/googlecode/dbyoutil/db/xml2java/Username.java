...
/**
 *  Class corresponding to a <i>USERNAME</i> element in XML.
 *  <p>
 ...
 */
public class Username  implements XMLPCDataElement {
	/** The name of this class' corresponding XML element. (<i>"USERNAME"</i>) */
	public static final String ELEMENT_NAME="USERNAME";
	//----------------------------------------------------------------------------- attribute member
	/* XML element USERNAME has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"USERNAME"</i> which is this class' corresponding XML Element.
	 */
