...
/**
 *  Class corresponding to a <i>ELAPSED_SECONDS</i> element in XML.
 *  <p>
 ...
 */
public class ElapsedSeconds  implements XMLPCDataElement {
	/** The name of this class' corresponding XML element. (<i>"ELAPSED_SECONDS"</i>) */
	public static final String ELEMENT_NAME="ELAPSED_SECONDS";
	//----------------------------------------------------------------------------- attribute member
	/* XML element ELAPSED_SECONDS has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"ELAPSED_SECONDS"</i> which is this class' corresponding XML Element.
	 */
