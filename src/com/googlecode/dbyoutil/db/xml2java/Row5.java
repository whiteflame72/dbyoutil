...
/**
 *  Class corresponding to a <i>row5</i> element in XML.
 *  <p>
 ...
 */
public class Row5  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row5"</i>) */
	public static final String ELEMENT_NAME="row5";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row5 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row5"</i> which is this class' corresponding XML Element.
	 */
