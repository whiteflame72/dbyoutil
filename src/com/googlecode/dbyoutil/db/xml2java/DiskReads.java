...
/**
 *  Class corresponding to a <i>DISK_READS</i> element in XML.
 *  <p>
 ...
 */
public class DiskReads  implements XMLPCDataElement {
	/** The name of this class' corresponding XML element. (<i>"DISK_READS"</i>) */
	public static final String ELEMENT_NAME="DISK_READS";
	//----------------------------------------------------------------------------- attribute member
	/* XML element DISK_READS has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"DISK_READS"</i> which is this class' corresponding XML Element.
	 */
