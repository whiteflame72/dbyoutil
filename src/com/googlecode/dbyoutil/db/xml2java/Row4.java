...
/**
 *  Class corresponding to a <i>row4</i> element in XML.
 *  <p>
 ...
 */
public class Row4  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row4"</i>) */
	public static final String ELEMENT_NAME="row4";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row4 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row4"</i> which is this class' corresponding XML Element.
	 */
