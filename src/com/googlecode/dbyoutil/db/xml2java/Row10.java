...
/**
 *  Class corresponding to a <i>row10</i> element in XML.
 *  <p>
 ...
 */
public class Row10  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row10"</i>) */
	public static final String ELEMENT_NAME="row10";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row10 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row10"</i> which is this class' corresponding XML Element.
	 */
