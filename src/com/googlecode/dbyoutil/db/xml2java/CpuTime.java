...
/**
 *  Class corresponding to a <i>CPU_TIME</i> element in XML.
 *  <p>
 ...
 */
public class CpuTime  implements XMLPCDataElement {
	/** The name of this class' corresponding XML element. (<i>"CPU_TIME"</i>) */
	public static final String ELEMENT_NAME="CPU_TIME";
	//----------------------------------------------------------------------------- attribute member
	/* XML element CPU_TIME has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"CPU_TIME"</i> which is this class' corresponding XML Element.
	 */
