...
/**
 *  Class corresponding to a <i>BUFFER_GETS</i> element in XML.
 *  <p>
 ...
 */
public class BufferGets  implements XMLPCDataElement {
	/** The name of this class' corresponding XML element. (<i>"BUFFER_GETS"</i>) */
	public static final String ELEMENT_NAME="BUFFER_GETS";
	//----------------------------------------------------------------------------- attribute member
	/* XML element BUFFER_GETS has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"BUFFER_GETS"</i> which is this class' corresponding XML Element.
	 */
