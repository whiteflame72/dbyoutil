...
/**
 *  Class corresponding to a <i>LAST_ACTIVE_TIME</i> element in XML.
 *  <p>
 ...
 */
public class LastActiveTime  implements XMLPCDataElement {
	/** The name of this class' corresponding XML element. (<i>"LAST_ACTIVE_TIME"</i>) */
	public static final String ELEMENT_NAME="LAST_ACTIVE_TIME";
	//----------------------------------------------------------------------------- attribute member
	/* XML element LAST_ACTIVE_TIME has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"LAST_ACTIVE_TIME"</i> which is this class' corresponding XML Element.
	 */
