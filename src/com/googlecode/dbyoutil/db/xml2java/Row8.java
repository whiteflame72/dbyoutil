...
/**
 *  Class corresponding to a <i>row8</i> element in XML.
 *  <p>
 ...
 */
public class Row8  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row8"</i>) */
	public static final String ELEMENT_NAME="row8";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row8 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row8"</i> which is this class' corresponding XML Element.
	 */
