...
/**
 *  Class corresponding to a <i>row3</i> element in XML.
 *  <p>
 ...
 */
public class Row3  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row3"</i>) */
	public static final String ELEMENT_NAME="row3";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row3 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row3"</i> which is this class' corresponding XML Element.
	 */
