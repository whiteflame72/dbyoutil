...
/**
 *  Class corresponding to a <i>row2</i> element in XML.
 *  <p>
 ...
 */
public class Row2  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row2"</i>) */
	public static final String ELEMENT_NAME="row2";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row2 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row2"</i> which is this class' corresponding XML Element.
	 */
