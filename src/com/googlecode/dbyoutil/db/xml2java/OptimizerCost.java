...
/**
 *  Class corresponding to a <i>OPTIMIZER_COST</i> element in XML.
 *  <p>
 ...
 */
public class OptimizerCost  implements XMLPCDataElement {
	/** The name of this class' corresponding XML element. (<i>"OPTIMIZER_COST"</i>) */
	public static final String ELEMENT_NAME="OPTIMIZER_COST";
	//----------------------------------------------------------------------------- attribute member
	/* XML element OPTIMIZER_COST has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"OPTIMIZER_COST"</i> which is this class' corresponding XML Element.
	 */
