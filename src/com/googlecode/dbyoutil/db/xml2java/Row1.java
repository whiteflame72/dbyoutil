...
/**
 *  Class corresponding to a <i>row1</i> element in XML.
 *  <p>
 ...
 */
public class Row1  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row1"</i>) */
	public static final String ELEMENT_NAME="row1";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row1 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row1"</i> which is this class' corresponding XML Element.
	 */
