...
/**
 *  Class corresponding to a <i>row6</i> element in XML.
 *  <p>
 ...
 */
public class Row6  implements XMLElement {
	/** The name of this class' corresponding XML element. (<i>"row6"</i>) */
	public static final String ELEMENT_NAME="row6";
	//----------------------------------------------------------------------------- attribute member
	/* XML element row6 has no attributes */
	//----------------------------------------------------------------------------- content member
	 ...
	 *  @return <i>"row6"</i> which is this class' corresponding XML Element.
	 */
