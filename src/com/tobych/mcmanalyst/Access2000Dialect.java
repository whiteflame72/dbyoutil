// $Id: Access2000Dialect.java,v 1.2 2006/03/21 21:08:24 tobych Exp $
 ...
 *
 * Microsoft's documentation on Microsoft Jet SQL for Access 2000:
 *
...
/*
  ...
  Also perhaps the ODBC driver, and how it's set up: connection pooling is not allowed
 */

import org.hibernate.dialect.*; // coz the dialects in the distro are in package net.sf.hibernate.dialect
...
public class Access2000Dialect extends Dialect {
	...
	public JoinFragment createOuterJoinFragment() {
		//return new AccessJoinFragment();	//not sure how to implement this
